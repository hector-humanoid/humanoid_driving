...
//    current_head_pan_ = current_head_positions[0];
    current_head_tilt_ = current_head_positions[0];
...
//    }
    ...
    double tilt_factor = std::min(1.0, 0.4*fabs(last_command_received_.absolute_head_tilt - current_head_positions[0]));
    if ( last_command_received_.absolute_head_tilt >= current_head_positions[0] ) {
